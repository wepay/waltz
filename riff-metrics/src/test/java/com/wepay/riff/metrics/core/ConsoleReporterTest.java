...
public class ConsoleReporterTest {
    ...
    private final PrintStream output = new PrintStream(bytes, true, "UTF-8");
    ...
    public ConsoleReporterTest() throws UnsupportedEncodingException {
    }
    ...
    public void setUp() throws Exception {
        ...
        dateHeader = javaVersion.startsWith("1.8")
                ? "3/17/13 6:04:36 PM ============================================================="
                : "3/17/13, 6:04:36 PM ============================================================";
    }
    ...
    public void reportsGaugeValues() throws Exception {
        ...
        reporter.report(map(new MetricId("group", "gauge"), gauge),
                map(),
                map(),
                map(),
                map());
    ...
    public void reportsCounterValues() throws Exception {
        ...
        reporter.report(map(),
                map(new MetricId("group", "test.counter"), counter),
                map(),
                map(),
                map());
    ...
    public void reportsHistogramValues() throws Exception {
        ...
        reporter.report(map(),
                map(),
                map(new MetricId("group", "test.histogram"), histogram),
                map(),
                map());
    ...
    public void reportsMeterValues() throws Exception {
        ...
        reporter.report(map(),
                map(),
                map(),
                map(new MetricId("group", "test.meter"), meter),
                map());
    ...
    public void reportsTimerValues() throws Exception {
        ...
        reporter.report(map(),
                ...
                map(),
                map(),
                map(new MetricId("group", "test.another.timer"), timer));
