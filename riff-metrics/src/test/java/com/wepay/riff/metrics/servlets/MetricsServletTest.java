...
public class MetricsServletTest extends AbstractServletTest {
    ...
    protected void setUp(ServletTester tester) {
        ...
        tester.getContext().setInitParameter("com.wepay.riff.metrics.servlets.MetricsServlet.allowedOrigin", "*");
    }
    ...
    public void returnsA200() throws Exception {
        ...
        assertThat(response.getContent())
                .isEqualTo("{"
                        ...
                        + "},"
                        + "\"meters\":{"
                        + "\"group.m\":{\"count\":1,\"m15_rate\":0.0,\"m1_rate\":0.0,\"m5_rate\":0.0,\"mean_rate\":3333333.3333333335,\"units\":\"events/second\"}},\"timers\":{\"group.t\":{\"count\":1,\"max\":1.0,\"mean\":1.0,\"min\":1.0,\"p50\":1.0,\"p75\":1.0,\"p95\":1.0,\"p98\":1.0,\"p99\":1.0,\"p999\":1.0,\"stddev\":0.0,\"m15_rate\":0.0,\"m1_rate\":0.0,\"m5_rate\":0.0,\"mean_rate\":1.0E7,\"duration_units\":\"seconds\",\"rate_units\":\"calls/second\"}"
                        + "}"
                        + "}");
    ...
    public void returnsJsonpWhenInitParamSet() throws Exception {
        ...
        String callbackParamVal = "callbackParamVal";
        request.setURI("/metrics?" + callbackParamName + "=" + callbackParamVal);
        tester.getContext().setInitParameter("com.wepay.riff.metrics.servlets.MetricsServlet.jsonpCallback", callbackParamName);
        processRequest();
