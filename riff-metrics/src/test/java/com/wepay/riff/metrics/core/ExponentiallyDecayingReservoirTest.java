...
import com.wepay.riff.metrics.core.Timer.Context;
...
public class ExponentiallyDecayingReservoirTest {
    ...
    @Test
    public void longPeriodsOfInactivityFetchShouldResample() {
        final ManualClock clock = new ManualClock();
    ...
    @Test
    public void emptyReservoirSnapshotShouldReturnZeroForAllValues() {
