...
import com.wepay.riff.metrics.health.HealthCheck;
import com.wepay.riff.metrics.health.HealthCheckFilter;
...
public class HealthCheckServletTest extends AbstractServletTest {
    ...
    protected void setUp(ServletTester tester) {
        ...
        tester.setAttribute("com.wepay.riff.metrics.servlets.HealthCheckServlet.registry", registry);
        tester.setAttribute("com.wepay.riff.metrics.servlets.HealthCheckServlet.executor", threadPool);
        tester.setAttribute("com.wepay.riff.metrics.servlets.HealthCheckServlet.healthCheckFilter",
