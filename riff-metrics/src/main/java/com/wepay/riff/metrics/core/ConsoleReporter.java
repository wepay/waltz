...
public final class ConsoleReporter extends ScheduledReporter {
    ...
    private ConsoleReporter(Builder builder) {
        super(builder.registry,
              ...
              builder.executor,
              builder.shutdownExecutorOnStop,
    ...
    public void report(SortedMap<MetricId, Gauge> gauges,
                       SortedMap<MetricId, Counter> counters,
                       SortedMap<MetricId, Histogram> histograms,
                       SortedMap<MetricId, Meter> meters,
                       SortedMap<MetricId, Timer> timers) {
        ...
        if (!gauges.isEmpty()) {
            ...
            for (Map.Entry<MetricId, Gauge> entry : gauges.entrySet()) {
                output.println(entry.getKey().getFullName());
    ...
    private void printCounter(Map.Entry<MetricId, Counter> entry) {
