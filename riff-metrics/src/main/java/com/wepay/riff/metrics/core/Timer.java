...
public class Timer implements Metered, Sampling {
     ...
     * @throws E    if {@code event} throws an Exception
     */
    ...
    public void time(Runnable event) {
        try {
            time((CheckedRunnable) event::run);
        } catch (Exception e) {
    ...
    /**
     * The <code>CheckedRunnable</code> interface is the same as <code>Runnable
     * </code> except it declares exception.
     */
    @FunctionalInterface
