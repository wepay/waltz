...
public class InstrumentedHandler extends HandlerWrapper {
    ...
    protected void doStart() throws Exception {
        ...
        this.requests = metricRegistry.timer("jetty", name(prefix, "requests"));
        this.dispatches = metricRegistry.timer("jetty", name(prefix, "dispatches"));

        this.activeRequests = metricRegistry.counter("jetty", name(prefix, "active-requests"));
        this.activeDispatches = metricRegistry.counter("jetty", name(prefix, "active-dispatches"));
        this.activeSuspended = metricRegistry.counter("jetty", name(prefix, "active-suspended"));

        this.asyncDispatches = metricRegistry.meter("jetty", name(prefix, "async-dispatches"));
        this.asyncTimeouts = metricRegistry.meter("jetty", name(prefix, "async-timeouts"));

        this.responses = new Meter[]{
                metricRegistry.meter("jetty", name(prefix, "1xx-responses")), // 1xx
                metricRegistry.meter("jetty", name(prefix, "2xx-responses")), // 2xx
                metricRegistry.meter("jetty", name(prefix, "3xx-responses")), // 3xx
                metricRegistry.meter("jetty", name(prefix, "4xx-responses")), // 4xx
                metricRegistry.meter("jetty", name(prefix, "5xx-responses"))  // 5xx
        };

        this.getRequests = metricRegistry.timer("jetty", name(prefix, "get-requests"));
        this.postRequests = metricRegistry.timer("jetty", name(prefix, "post-requests"));
        this.headRequests = metricRegistry.timer("jetty", name(prefix, "head-requests"));
        this.putRequests = metricRegistry.timer("jetty", name(prefix, "put-requests"));
        this.deleteRequests = metricRegistry.timer("jetty", name(prefix, "delete-requests"));
        this.optionsRequests = metricRegistry.timer("jetty", name(prefix, "options-requests"));
        this.traceRequests = metricRegistry.timer("jetty", name(prefix, "trace-requests"));
        this.connectRequests = metricRegistry.timer("jetty", name(prefix, "connect-requests"));
        this.moveRequests = metricRegistry.timer("jetty", name(prefix, "move-requests"));
        this.otherRequests = metricRegistry.timer("jetty", name(prefix, "other-requests"));

        metricRegistry.register("jetty", name(prefix, "percent-4xx-1m"), new RatioGauge() {
            @Override
        ...
        metricRegistry.register("jetty", name(prefix, "percent-4xx-5m"), new RatioGauge() {
            @Override
            protected Ratio getRatio() {
        ...
        metricRegistry.register("jetty", name(prefix, "percent-4xx-15m"), new RatioGauge() {
            @Override
            protected Ratio getRatio() {
        ...
        metricRegistry.register("jetty", name(prefix, "percent-5xx-1m"), new RatioGauge() {
            @Override
            protected Ratio getRatio() {
        ...
        metricRegistry.register("jetty", name(prefix, "percent-5xx-5m"), new RatioGauge() {
            @Override
            protected Ratio getRatio() {
        ...
        metricRegistry.register("jetty", name(prefix, "percent-5xx-15m"), new RatioGauge() {
            @Override
