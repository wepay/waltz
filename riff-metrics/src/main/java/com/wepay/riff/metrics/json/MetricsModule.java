package com.wepay.riff.metrics.json;
...
public class MetricsModule extends Module {
    ...
    private static final class GaugeSerializer extends StdSerializer<Gauge> {
    ...
    private static final class CounterSerializer extends StdSerializer<Counter> {
    ...
    private static final class HistogramSerializer extends StdSerializer<Histogram> {
    ...
    private static final class MeterSerializer extends StdSerializer<Meter> {
    ...
    private static final class TimerSerializer extends StdSerializer<Timer> {
    ...
    private static final class MetricRegistrySerializer extends StdSerializer<MetricRegistry> {

        private static final long serialVersionUID = 1L;

        @SuppressFBWarnings(justification = "Never serialize this field", value = "SE_BAD_FIELD")
